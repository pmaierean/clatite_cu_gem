 ...
 *
 */
public class PrivilegePathRuleError implements Serializable {
	private static final long serialVersionUID = -5470622071987566751L;
	private String path;
	private List<String> expected, effective;
