...
/**
 * Copied form org.apache.poi.util.LittleEndian
...
public final class STLUtil {
    ...
    public static float arr2double(final byte[] data, final int offset) {
    ...
    public static void putByte(byte[] data, int offset, int value) {
        putNumber(data, offset, value, BYTE_SIZE);
    }
    ...
    public static byte[] int2array(final int value) {
    	byte[] buffer = new byte[4];
    	putInt(buffer, 0, value);
    	return buffer;
    }
    ...
    /**
     * Converts a double to a 4 bytes array
     * @param value
     * @return
     */
    public static byte[] double2arr(final float value) {
    	byte[] buffer = new byte[4];
        if (Double.isNaN(value))
            putNumber(buffer, 0, -276939487313920L, INT_SIZE);
        else
            putNumber(buffer, 0, Float.floatToRawIntBits(value), INT_SIZE);
    	return buffer;
    }
    ...
    /**
     * Get a string representation of the array of bytes
     * @param raw
     * @return
     */
