 ...
 */
package com.maiereni.web.jaxrs.service.impl;
...
public class RetirementServiceImpl implements RetirementService {
	private static final Logger logger = LoggerFactory.getLogger(RetirementServiceImpl.class);
	private static final String SERVICE_NAME = "Retirement Planning";
