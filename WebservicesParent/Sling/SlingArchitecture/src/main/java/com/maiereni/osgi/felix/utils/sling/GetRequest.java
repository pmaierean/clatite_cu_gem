 ...
 *
 */
public class GetRequest extends BaseAdminConsoleClient {
	private List<Cookie> cookies;
	private String urlTemplate;
	
	public GetRequest(String host, ObjectMapper mapper, List<Cookie> cookies) {
		super(host, mapper);
	...
	public ValidationResponse validate(final String uri) {
		...
		try {
			ResponseBean bean = get(urlTemplate + uri, EMPTY_PARAMS, NO_HEADER, cookies);
